...
from sweepai.core.entities import FileChangeRequest, Message, RegexMatchError, Snippet
...
def validate_change(
    ...
    if not original_code:
        ...
        previous_fcr_occurrences = (
            []
        )  # [contains_ignoring_whitespace(fcr["new_code"][0], original_code) for fcr in previous_parsed_fcrs]
